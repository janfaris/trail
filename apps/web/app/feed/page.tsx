  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 w-full">
        ...
        <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 md:px-6 lg:grid-cols-[minmax(0,720px)_320px]">
          <section className="min-w-0 overflow-hidden rounded-[28px] bg-zinc-950 shadow-[0_0_0_1px_rgba(255,255,255,0.08),0_28px_90px_rgba(0,0,0,0.38)]">
            <div className="sticky top-14 z-20 border-b border-zinc-900/90 bg-zinc-950/90 backdrop-blur-xl">
              <div className="flex items-end justify-between gap-4 px-5 py-4 md:px-6">
                <div>
              ...
              <div className="grid grid-cols-2 border-t border-zinc-900/90 p-1">
                <Link
                  href="/feed"
                ...
                <div className="grid gap-4 md:grid-cols-[52px_1fr]">
                  ...
                  <div>
                    ...
                    <div className="mt-5 flex flex-wrap gap-2">
                      <TrailLink
                        href={FOLLOWING_SIGN_IN_HREF}
                        className="inline-flex min-h-10 items-center rounded-full bg-[#a7f300] px-4 font-mono text-[11px] uppercase tracking-[0.14em] text-black transition-[background-color,transform] hover:bg-[#c8ff5e] active:scale-[0.96]"
                      >
                        Sign in to follow
                      </TrailLink>
                      <Link
                        href="/install"
                        className="inline-flex min-h-10 items-center rounded-full bg-black px-4 font-mono text-[11px] uppercase tracking-[0.14em] text-zinc-200 shadow-[0_0_0_1px_rgba(255,255,255,0.08)] transition-[box-shadow,color,transform] hover:text-white hover:shadow-[0_0_0_1px_rgba(255,255,255,0.16)] active:scale-[0.96]"
                      >
                        Install Trail
                      </Link>
                    </div>
            ...
            {rows.length === 0 ? (
              ...
              <ul className="divide-y divide-zinc-900/90">
                {rows.map((r) => {
                  ...
                  return (
                    <li key={r.id}>
                      <article className="group grid grid-cols-[44px_minmax(0,1fr)] gap-4 px-5 py-5 transition-[background-color] hover:bg-zinc-900/45 md:grid-cols-[52px_minmax(0,1fr)] md:px-6">
                        <Link
                          href={authorHref}
                        ...
                        <div className="min-w-0">
                          <div className="flex items-start justify-between gap-3">
                            ...
                            {viewerId && viewerId !== r.authorId ? (
                              ...
                              <TrailLink
                                ...
                                className="inline-flex min-h-9 shrink-0 items-center rounded-full border border-zinc-800 px-3 font-mono text-[11px] uppercase tracking-[0.12em] text-zinc-300 transition-[border-color,color,transform] hover:border-[#a7f300] hover:text-[#a7f300] active:scale-[0.96]"
                              >
                                Follow
                              </TrailLink>
                            ) : null}
                          ...
                          <Link href={currentReceiptHref} className="mt-3 block">
                            ...
                            <h3 className="mt-4 text-balance text-[20px] font-medium leading-snug tracking-[-0.03em] text-zinc-100 transition-colors group-hover:text-white">
                              {r.title ?? r.slug}
                            </h3>
                            {r.summary && (
                              <p className="mt-2 line-clamp-4 text-pretty text-[15px] leading-relaxed text-zinc-400">
                                {r.summary}
                              </p>
                            )}
                          </Link>
                          ...
                          <div className="mt-5 flex flex-wrap items-center justify-between gap-3 border-t border-zinc-900/80 pt-4">
