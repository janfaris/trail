...
const VENDORS: VendorMeta[] = [
  {
    ...
    keyHint: "Admin keys typically start with 'sk-ant-'.",
    workspacePlaceholder: "ws_… (optional)",
    description: "Claude API org usage and costs.",
  },
  {
    id: "cursor",
    name: "Cursor",
    live: false,
    keyPlaceholder: "Your Cursor admin key",
    keyHint: "We accept any non-empty key for now.",
  ...
  },
  {
    ...
    live: false,
    keyPlaceholder: "sk-…",
    keyHint: "OpenAI API keys typically start with 'sk-'.",
    workspacePlaceholder: "org-… (optional)",
    description: "OpenAI org usage and spend.",
  },
  {
    id: "copilot",
    name: "GitHub Copilot",
    ...
    keyHint: "Use a GitHub personal-access-token prefix.",
    workspacePlaceholder: "org login (optional)",
    description: "Copilot enterprise / business seat usage.",
  },
];
